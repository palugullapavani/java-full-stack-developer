  ...
  return(
    ...
    <div className=" md:w-1/3 mt-36 text-white ">
      <img
        ...
        alt="Sample img" />
        <Typography className=' text-center p-8'>Employee Login</Typography>
    </div>
    <div className="md:w-1/3 max-w-sm border-2 p-5 rounded-lg bg-white shadow-md ">
      
      
      {/* <input className="text-sm w-full px-4 py-2 border border-solid border-gray-300 rounded mt-4 text-black" type="text" placeholder="Email Address" /> */}
